          ...
          <div class="col-md-7 col-lg-6 col-xl-5">
            <div class="text-container ps-md-3">
                ...
                <i class="fas fa-check mx-2 my-1 text-danger"></i>
                  <div class="flex-1">
                    <h5>مشاوره رایگان</h5>
                    <small class="text-muted mb-4">مشاوره آنلاین، تلفنی و حضوری</small>
                  </div>
                </div>
                <div class="d-flex align-items-start mb-3">
                <i class="fas fa-check m-1 text-danger"></i>
                  <div class="flex-1">
                    <h5>طراحی نقشه سایت</h5>
                    <small class="text-muted mb-4">
                      تعیین تعداد و عنوان صفحات
                      </small>
                  </div>
                </div>
                <div class="d-flex align-items-start mb-3">
                <i class="fas fa-check m-1 text-danger"></i>
                  <div class="flex-1">
                    <h5>امکانات و ویژگی ها</h5>
                    <small class="text-muted mb-4">
                      بررسی تمامی ویژگی ها، بعلاه گرافیک، ترکیب رنگ ...
                      </small>
                  </div>
                </div>
                <div class="d-flex align-items-start mb-3">
                <i class="fas fa-check m-1 text-danger"></i>
                  <div class="flex-1">
                    <h5>قرارداد</h5>
                    <small class="text-muted mb-4">
                      عقد قرارداد به صورت غیر حضوری و یا حضوری با هماهنگی قبلی
                      </small>
                  </div>
                </div>
                <div class="d-flex align-items-start mb-3">
                <i class="fas fa-check m-1 text-danger"></i>
                  <div class="flex-1">
                    <h5>پشتیبانی</h5>
                    <small class="text-muted mb-4">
                  یک سال پشتیبانی رایگان هدیه تیم مشاوران وب
                    </small>
                  </div>
                </div>
